...
checkpoint = torch.load('./Brazil/E1_Landsat/models/BrazilLandsat.torch')
...
directory = "./Brazil/E1_Landsat/data/pass/"
...
pass_preds.to_csv("./Brazil/Ensemble/data/LandsatPassPreds.csv")


directory = "./Brazil/E1_Landsat/data/fail/"
transform = transforms.Compose([
	ImgAugTransform(),
	transforms.ToTensor(),
	transforms.Normalize([0.485, 0.456, 0.406], [0.229, 0.224, 0.225])
...
fail_preds.to_csv("./Brazil/Ensemble/data/LandsatFailPreds.csv")
