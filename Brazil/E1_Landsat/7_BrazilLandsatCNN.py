    ...
    for epoch in range(num_epochs):
        ...
        for phase in ['train', 'val']:
            ...
            if phase == 'val' and epoch_acc > best_acc:
                ...
                model_name = './Brazil/E1_Landsat/epochs/LandsatBrazil_Epoch' + str(epoch_num) + '.sav'
...
data_dir = './Brazil/E1_Landsat/data/'
...
final_model_name = './Brazil/E1_Landsat/models/BrazilLandsat.torch'
torch.save({
            'epoch': 0,
