    ...
    for epoch in range(num_epochs):
        ...
        for phase in ['train', 'val']:
            ...
            if phase == 'val' and epoch_acc > best_acc:
                ...
                model_name = './Brazil/E3_StreetView/epochs/StreetViewBrazil_Epoch' + str(epoch_num) + '.sav'
...
data_dir = './Brazil/E3_StreetView/data/'
...
final_model_name = './Brazil/E3_StreetView/models/BrazilStreetView.torch'
torch.save({
            'epoch': 50,
