...
checkpoint = torch.load('./Brazil/E2_Static/models/StaticBrazil_Transfer_50epoch.torch')
...
directory = "./Brazil/E2_Static/data/jpg/"
...
pass_preds.to_csv("./Brazil/Ensemble/data/BrazilPreds.csv")
