    ...
    for epoch in range(num_epochs):
        ...
        for phase in ['train', 'val']:
            ...
            if phase == 'val' and epoch_acc > best_acc:
                ...
                model_name = './Brazil/E2_Static/epochs/StaticBrazil_Transfer_Epoch' + str(epoch_num) + '.sav'
...
data_dir = './Brazil/E2_Static/data/'
...
checkpoint = torch.load('./India/E2_Static/transfer/PhilippinesStatic2.torch', map_location="cuda:0")
...
model_ft = train_model(model_ft, loss, optimizer_ft, exp_lr_scheduler,
                       num_epochs=50)
...
torch.save({
            ...
            'loss': loss,
            }, './Brazil/E2_Static/models/StaticBrazil_Transfer_50epoch.torch')
