    ...
    for epoch in range(num_epochs):
        ...
        for phase in ['train', 'val']:
            ...
            if phase == 'val' and epoch_acc > best_acc:
                ...
                model_name = './Philippines/Subject3_Math/E1_Math_Landsat/epochs/Landsat_Math_Epoch' + str(epoch_num) + '.sav'
...
data_dir = './Philippines/Subject3_Math/E1_Math_Landsat/data/'
...
final_model_name = './Philippines/Subject3_Math/E1_Math_Landsat/models/Landsat_Math_50epoch.torch'
torch.save({
            'epoch': 50,
