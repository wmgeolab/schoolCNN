...
df = pd.read_csv("./Philippines/Subject3_Math/E1_Math_Landsat/data/y1314_Math.csv")
df = df.drop(['intervention', 'latitude', 'longitude'], axis = 1)
#df['english_mean'] = df['overall_mean'] / 5

dta = pd.read_csv("./Philippines/Subject3_Math/Ensemble/data/EnsemblePreds_GPU.csv")
...
final_df.to_csv("./Philippines/Subject3_Math/Ensemble/data/PredictedAbsolute_Math.csv")
