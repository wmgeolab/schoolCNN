...
# Read in the data
df = pd.read_csv("./Philippines/Subject3_Math/E2_Math_Static/data/y1314_Math.csv")
df.head()

# Set up the base directory
directory = "./Philippines/Subject3_Math/E2_Math_Static/data/imagery/"
...
for filename in os.listdir(directory):
    ...
    if subset['intervention'].tolist()[0] == 1:
        shutil.copy(fname, "./Philippines/Subject3_Math/E2_Math_Static/data/fail/")
    ...
    if subset['intervention'].tolist()[0] == 0:
        shutil.copy(fname, "./Philippines/Subject3_Math/E2_Math_Static/data/pass/")
