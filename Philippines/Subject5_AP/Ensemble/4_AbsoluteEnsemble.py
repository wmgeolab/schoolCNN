...
df = pd.read_csv("./Philippines/Subject5_AP/E1_AP_Landsat/data/y1314_AP.csv")
df = df.drop(['intervention', 'latitude', 'longitude'], axis = 1)
#df['english_mean'] = df['overall_mean'] / 5

dta = pd.read_csv("./Philippines/Subject5_AP/Ensemble/data/EnsemblePreds_GPU.csv")
...
y_train = train.pop("ap_mean")
x_train = train

y_test = test.pop("ap_mean")
x_test = test
...
final_df['actual_mean'] = dta['ap_mean']
...
final_df.to_csv("./Philippines/Subject5_AP/Ensemble/data/PredictedAbsolute_AP.csv")
