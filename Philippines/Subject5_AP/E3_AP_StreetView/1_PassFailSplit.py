...
# Read in the data
df = pd.read_csv("./Philippines/Subject5_AP/E3_AP_StreetView/data/y1314_AP.csv")
df.head()

# Set up the base directory
directory = "./Philippines/Subject5_AP/E3_AP_StreetView/data/imagery/"
...
for filename in os.listdir(directory):
    ...
    if subset['intervention'].tolist()[0] == 1:
        shutil.copy(fname, "./Philippines/Subject5_AP/E3_AP_StreetView/data/fail/")
    ...
    if subset['intervention'].tolist()[0] == 0:
        shutil.copy(fname, "./Philippines/Subject5_AP/E3_AP_StreetView/data/pass/")
