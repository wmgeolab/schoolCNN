    ...
    for epoch in range(num_epochs):
        ...
        for phase in ['train', 'val']:
            ...
            if phase == 'val' and epoch_acc > best_acc:
                ...
                model_name = './Philippines/Subject5_AP/E1_AP_Landsat/epochs/Landsat_AP_Epoch' + str(epoch_num) + '.sav'
...
data_dir = './Philippines/Subject5_AP/E1_AP_Landsat/data/'
...
final_model_name = './Philippines/Subject5_AP/E1_AP_Landsat/models/Landsat_AP_50epoch.torch'
torch.save({
            'epoch': 50,
