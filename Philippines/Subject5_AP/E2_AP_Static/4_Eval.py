...
model_ft = joblib.load("./Philippines/Subject5_AP/E2_AP_Static/models/Static_AP_50epoch.sav")
...
pass_preds.to_csv("./Philippines/Subject5_AP/Ensemble/data/StaticPreds_GPU.csv")
