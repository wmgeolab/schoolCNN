    ...
    for epoch in range(num_epochs):
        ...
        for phase in ['train', 'val']:
            ...
            if phase == 'val' and epoch_acc > best_acc:
                ...
                model_name = './Philippines/Subject5_AP/E2_AP_Static/epochs/Static_AP_Epoch' + str(epoch_num) + '.sav'
...
data_dir = './Philippines/Subject5_AP/E2_AP_Static/data/'
...
final_model_name = './Philippines/Subject5_AP/E2_AP_Static/models/Static_AP_50epoch.torch'
torch.save({
            'epoch': 50,
