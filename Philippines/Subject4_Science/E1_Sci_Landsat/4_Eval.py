...
model_ft = joblib.load("./Philippines/Subject4_Science/E1_Sci_Landsat/models/")
directory = "./Philippines/Subject4_Science/E1_Sci_Landsat/data/pass/"
...
pass_preds.to_csv("./Philippines/Subject4_Science/Ensemble/data/LandsatPassPreds.csv")



directory = "./Philippines/Subject4_Science/E1_Sci_Landsat/data/fail/"
transform = transforms.Compose([
	ImgAugTransform(),
	transforms.ToTensor(),
	transforms.Normalize([0.485, 0.456, 0.406], [0.229, 0.224, 0.225])
...
fail_preds.to_csv("./Philippines/Subject4_Science/Ensemble/data/LandsatFailPreds.csv")
