    ...
    for epoch in range(num_epochs):
        ...
        for phase in ['train', 'val']:
            ...
            if phase == 'val' and epoch_acc > best_acc:
                ...
                model_name = './Philippines/Subject4_Science/E1_Sci_Landsat/epochs/Landsat_Sci_Epoch' + str(epoch_num) + '.sav'
...
data_dir = './Philippines/Subject4_Science/E1_Sci_Landsat/data/'
...
final_model_name = './Philippines/Subject4_Science/E1_Sci_Landsat/models/Landsat_Sci_50epoch.torch'
