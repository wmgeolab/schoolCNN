    ...
    for epoch in range(num_epochs):
        ...
        for phase in ['train', 'val']:
            ...
            if phase == 'val' and epoch_acc > best_acc:
                ...
                model_name = './Philippines/Subject4_Science/E3_Sci_StreetView/epochs/StreetView_Sci_Epoch' + str(epoch_num) + '.sav'
...
data_dir = './Philippines/Subject4_Science/E3_Sci_StreetView/data/'
...
final_model_name = './Philippines/Subject4_Science/E3_Sci_StreetView/models/StreetView_Sci_50epoch.torch'
