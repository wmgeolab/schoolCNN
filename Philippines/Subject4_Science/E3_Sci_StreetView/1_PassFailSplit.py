...
# Read in the data
df = pd.read_csv("./Philippines/Subject4_Science/E3_Sci_StreetView/data/y1314_Science.csv")
df.head()

# Set up the base directory
directory = "./Philippines/Subject4_Science/E3_Sci_StreetView/data/imagery/"
...
for filename in os.listdir(directory):
    ...
    if subset['intervention'].tolist()[0] == 1:
        shutil.copy(fname, "./Philippines/Subject4_Science/E3_Sci_StreetView/data/fail/")
    ...
    if subset['intervention'].tolist()[0] == 0:
        shutil.copy(fname, "./Philippines/Subject4_Science/E3_Sci_StreetView/data/pass/")
