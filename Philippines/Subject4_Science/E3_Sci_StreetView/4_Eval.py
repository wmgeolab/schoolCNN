...
model_ft = joblib.load("./Philippines/Subject4_Science/E3_Sci_StreetView/models/StreetViewResNeXt101_Sci_10epoch.sav")
directory = "./Philippines/AllSubjects/Ensemble3_StreetViewResNet152/data/imagery/"
...
pass_preds.to_csv("./Philippines/Subject4_Science/Ensemble/data/StreetViewPreds_GPU.csv")
