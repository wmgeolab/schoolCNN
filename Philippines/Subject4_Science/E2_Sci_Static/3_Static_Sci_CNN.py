    ...
    for epoch in range(num_epochs):
        ...
        for phase in ['train', 'val']:
            ...
            if phase == 'val' and epoch_acc > best_acc:
                ...
                model_name = './Philippines/Subject4_Science/E2_Sci_Static/epochs/Static_Sci_Epoch' + str(epoch_num) + '.sav'
...
data_dir = './Philippines/Subject4_Science/E2_Sci_Static/data/'
...
final_model_name = './Philippines/Subject4_Science/E2_Sci_Static/models/Static_Sci_50epoch.torch'
torch.save({
            'epoch': 50,
