...
model_ft = joblib.load("./Philippines/Subject4_Science/E2_Sci_Static/models/StaticResNeXt101_Sci_50epoch.sav")
directory = "./Philippines/AllSubjects/Ensemble2_StaticResNeXt101/data/jpg/"
...
pass_preds.to_csv("./Philippines/Subject4_Science/Ensemble/data/StaticPreds_GPU.csv")
