...
dta = pd.read_csv("./Philippines/Subject4_Science/E1_Sci_Landsat/data/y1314_Science.csv")
dta = dta.drop(['science_mean', 'latitude', 'longitude'], axis = 1)
dta.head()

# Landsat
landsat_pass = pd.read_csv("./Philippines/Subject4_Science/Ensemble/data/LandsatPassPreds_GPU.csv")
landsat_pass = landsat_pass.drop(['Unnamed: 0'], axis = 1)
landsat_pass.head()
landsat_pass.shape

landsat_fail = pd.read_csv("./Philippines/Subject4_Science/Ensemble/data/LandsatFailPreds_GPU.csv")
...
# Static
static = pd.read_csv("./Philippines/Subject4_Science/Ensemble/data/StaticPreds_GPU.csv")
...
sv = pd.read_csv("./Philippines/Subject4_Science/Ensemble/data/StreetViewPreds_GPU.csv")
...
comb.to_csv("./Philippines/Subject4_Science/Ensemble/data/EnsemblePreds_GPU.csv", index = False)