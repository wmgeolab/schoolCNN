...
dta = pd.read_csv("./Philippines/Subject2_Filipino/E1_Fil_Landsat/data/y1314_Filipino.csv")
dta = dta.drop(['filipino_mean', 'latitude', 'longitude'], axis = 1)
dta.head()

# Landsat
landsat_pass = pd.read_csv("./Philippines/Subject2_Filipino/Ensemble/data/LandsatPassPreds_GPU.csv")
landsat_pass = landsat_pass.drop(['Unnamed: 0'], axis = 1)
landsat_pass.head()
landsat_pass.shape

landsat_fail = pd.read_csv("./Philippines/Subject2_Filipino/Ensemble/data/LandsatFailPreds_GPU.csv")
...
# Static
static = pd.read_csv("./Philippines/Subject2_Filipino/Ensemble/data/StaticPreds_GPU.csv")
...
sv = pd.read_csv("./Philippines/Subject2_Filipino/Ensemble/data/StreetViewPreds_GPU.csv")
...
comb.to_csv("./Philippines/Subject2_Filipino/Ensemble/data/EnsemblePreds_GPU.csv", index = False)