...
df = pd.read_csv("./Philippines/Subject2_Filipino/E1_Fil_Landsat/data/y1314_Filipino.csv")
df = df.drop(['intervention', 'latitude', 'longitude'], axis = 1)

dta = pd.read_csv("./Philippines/Subject2_Filipino/Ensemble/data/EnsemblePreds_GPU.csv")
...
final_df.to_csv("./Philippines/Subject2_Filipino/Ensemble/data/PredictedAbsolute_Filipino.csv")
