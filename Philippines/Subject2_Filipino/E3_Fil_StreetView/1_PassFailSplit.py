...
# Read in the data
df = pd.read_csv("./Philippines/Subject2_Filipino/E3_Fil_StreetView/data/y1314_Filipino.csv")
df.head()

# Set up the base directory
directory = "./Philippines/Subject2_Filipino/E3_Fil_StreetView/data/imagery/"
...
for filename in os.listdir(directory):
    ...
    if subset['intervention'].tolist()[0] == 1:
        shutil.copy(fname, "./Philippines/Subject2_Filipino/E3_Fil_StreetView/data/fail/")
    ...
    if subset['intervention'].tolist()[0] == 0:
        shutil.copy(fname, "./Philippines/Subject2_Filipino/E3_Fil_StreetView/data/pass/")
