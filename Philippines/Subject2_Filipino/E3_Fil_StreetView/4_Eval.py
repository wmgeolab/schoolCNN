...
checkpoint = torch.load("./Philippines/Subject2_Filipino/E3_Fil_StreetView/models/StreetView_50epoch.torch")
...
static_preds.head()
static_preds.to_csv("./Philippines/Subject2_Filipino/Ensemble/data/StreetViewPreds.csv")
