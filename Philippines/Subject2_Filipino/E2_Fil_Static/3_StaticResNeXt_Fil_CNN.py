    ...
    for epoch in range(num_epochs):
        ...
        for phase in ['train', 'val']:
            ...
            if phase == 'val' and epoch_acc > best_acc:
                ...
                model_name = './Philippines/Subject2_Filipino/E2_Fil_Static/epochs/Static_Fil_Epoch' + str(epoch_num) + '.sav'
...
data_dir = './Philippines/Subject2_Filipino/E2_Fil_Static/data/'
...
final_model_name = './Philippines/Subject2_Filipino/E2_Fil_Static/models/Static_Fil_50epoch.torch'
torch.save({
            'epoch': 50,
