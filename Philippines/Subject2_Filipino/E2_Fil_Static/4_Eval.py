...
checkpoint = torch.load("./Philippines/Subject2_Filipino/E2_Eng_StreetView/models/Static_50epoch.torch")
...
allpreds.head()
allpreds.to_csv("./Philippines/Subject2_Filipino/Ensemble/data/StaticPreds_GPU.csv")
