...
checkpoint = torch.load("./Philippines/Subject1_English/E1_Eng_Landsat/models/Landsat_50epoch.torch")
...
pass_preds.to_csv("./Philippines/Subject1_English/Ensemble/data/LandsatPassPreds_GPU.csv")



directory = "./Philippines/Subject1_English/Ensemble1_English_LandsatResNeXt101/data/fail/"
transform = transforms.Compose([
	ImgAugTransform(),
	transforms.ToTensor(),
	transforms.Normalize([0.485, 0.456, 0.406], [0.229, 0.224, 0.225])
...
fail_preds.to_csv("./Philippines/Subject1_English/Ensemble/data/LandsatFailPreds_GPU.csv")
