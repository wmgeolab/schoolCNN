    ...
    for epoch in range(num_epochs):
        ...
        for phase in ['train', 'val']:
            ...
            if phase == 'val' and epoch_acc > best_acc:
                ...
                model_name = './Philippines/Subject1_English/E1_Landsat/epochs/Landsat_Eng_Epoch' + str(epoch_num) + '.sav'
...
data_dir = './Philippines/Subject1_English/E1_Landsat/data/'
...
final_model_name = './Philippines/Subject1_English/E1_Landsat/models/Landsat_Eng_50epoch.sav'
torch.save({
            'epoch': 50,
