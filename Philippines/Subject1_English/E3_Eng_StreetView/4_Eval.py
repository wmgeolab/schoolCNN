...
checkpoint = torch.load("./Philippines/Subject1_English/E2_Eng_StreetView/models/StreetView_50epoch.torch")
...
static_preds.to_csv("./Philippines/Subject1_English/Ensemble/data/StreetViewPreds_GPU.csv")
