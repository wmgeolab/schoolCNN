    ...
    for epoch in range(num_epochs):
        ...
        for phase in ['train', 'val']:
            ...
            if phase == 'val' and epoch_acc > best_acc:
                ...
                model_name = './Philippines/Subject1_English/E3_Eng_StreetView/epochs/StreetView_Eng_Epoch' + str(epoch_num) + '.sav'
...
data_dir = './Philippines/Subject1_English/E3_Eng_StreetView/data/'
...
final_model_name = './Philippines/Subject1_English/E3_Eng_StreetView/models/StreetView_Eng_50epoch.torch'
torch.save({
            'epoch': 50,
