...
# Read in the data
df = pd.read_csv("./Philippines/Subject1_English/E3_Eng_StreetView/data/y13-14_g6.csv")
df.head()

# Set up the base directory
directory = "./Philippines/Subject1_English/E3_Eng_StreetView/data/imagery/"
...
for filename in os.listdir(directory):
    ...
    if subset['intervention'].tolist()[0] == 1:
        shutil.copy(fname, "./Philippines/Subject1_English/E3_Eng_StreetView/data/fail/")
    ...
    if subset['intervention'].tolist()[0] == 0:
        shutil.copy(fname, "./Philippines/Subject1_English/E3_Eng_StreetView/data/pass/")
