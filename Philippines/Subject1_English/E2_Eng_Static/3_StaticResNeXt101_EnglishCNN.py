    ...
    for epoch in range(num_epochs):
        ...
        for phase in ['train', 'val']:
            ...
            if phase == 'val' and epoch_acc > best_acc:
                ...
                model_name = './Philippines/Subject1_English/E2_Eng_Static/epochs/Static_Eng_Epoch' + str(epoch_num) + '.sav'
...
data_dir = './Philippines/Subject1_English/E2_Eng_Static/data/'
...
final_model_name = './Philippines/Subject1_English/E2_Eng_Static/models/Static_Eng_50epoch.torch'
torch.save({
            'epoch': 50,
