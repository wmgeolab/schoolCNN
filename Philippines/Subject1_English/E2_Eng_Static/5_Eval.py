...
checkpoint = torch.load("./Philippines/Subject1_English/E2_Eng_Static/models/Static_50epoch.torch")
...
allpreds.to_csv("./Philippines/Subject1_English/Ensemble/data/StaticPreds_GPU.csv")
