...
df6 <- read.csv("./Philippines/Subject1_English/y13-14_g6.csv")
head(df6)

# Calculate the overall mean of NAT scores per school
#df6$mean <- df6$overall_mean_rs / 5

hist(df6$english_mean_rs)

range(df6$english_mean_rs)
...
coords <- read.csv("./Philippines/AllSubjects/Ensemble2_StaticResNeXt101/data/coords.csv")
...
# Write final CSV
write.csv(final_df, "./Philippines/Subject1_English/E1_Eng_Landsat/data/y1314_English.csv", row.names=FALSE)
write.csv(final_df, "./Philippines/Subject1_English/E1_Eng_Static/data/y1314_English.csv", row.names=FALSE)
write.csv(final_df, "./Philippines/Subject1_English/E1_Eng_StreetView/data/y1314_English.csv", row.names=FALSE)
