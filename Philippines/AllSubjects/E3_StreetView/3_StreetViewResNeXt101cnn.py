    ...
    for epoch in range(num_epochs):
        ...
        for phase in ['train', 'val']:
            ...
            if phase == 'val' and epoch_acc > best_acc:
                ...
                model_name = './clean/AllSubjects/E3_StreetView/epochs/StreetViewResNeXt101_Epoch' + str(epoch_num) + '.sav'
...
data_dir = './clean/AllSubjects/E3_StreetView/data/'
...
final_model_name = './Philippines/AllSubjects/E3_StreetView/models/StreetView_AllSubjects.torch'
torch.save({
            'epoch': 50,
