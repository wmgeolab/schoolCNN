...
# Read in the data
df = pd.read_csv("./Philippines/AllSubjects/E2_Static/data/y13-14_g6.csv")
df.head()
...
for filename in os.listdir(directory):
    ...
    if subset['intervention'].tolist()[0] == 1:
        shutil.copy(fname, "./Philippines/AllSubjects/E2_Static/data/fail/")
    ...
    if subset['intervention'].tolist()[0] == 0:
        shutil.copy(fname, "./Philippines/AllSubjects/E2_Static/data/pass/")
