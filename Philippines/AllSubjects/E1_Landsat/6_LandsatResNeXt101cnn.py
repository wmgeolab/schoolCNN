    ...
    for epoch in range(num_epochs):
        ...
        for phase in ['train', 'val']:
            ...
            if phase == 'val' and epoch_acc > best_acc:
                ...
                model_name = './Philippines/AllSubjects/E1_Landsat/epochs/LandsatResNeXt101_Epoch' + str(epoch_num) + '.sav'
...
data_dir = './Philippines/AllSubjects/E1_Landsat/data/'
...
final_model_name = './Philippines/AllSubjects/E1_Landsat/models/LandsatResNeXt101_50epoch.torch'
torch.save({
            'epoch': 50,
