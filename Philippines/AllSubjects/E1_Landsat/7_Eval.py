...
checkpoint = torch.load("./Philippines/AllSubjects/E1_Landsat/models/Landsat_50epoch.torch")
model_ft.load_state_dict(checkpoint['model_state_dict'])


directory = "./Philippines/AllSubjects/E1_Landsat/data/pass/"
...
pass_preds.to_csv("./Philippines/AllSubjects/Ensemble/data/LandsatPassPreds_GPU.csv")


directory = "./Philippines/AllSubjects/E1_Landsat/data/fail/"
transform = transforms.Compose([
	ImgAugTransform(),
	transforms.ToTensor(),
	transforms.Normalize([0.485, 0.456, 0.406], [0.229, 0.224, 0.225])
...
fail_preds.to_csv("./Philippines/AllSubjects/Ensemble/data/LandsatFailPreds_GPU.csv")
