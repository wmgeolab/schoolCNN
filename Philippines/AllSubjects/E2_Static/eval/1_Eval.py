...
model_ft = joblib.load("./clean/AllSubjects/E2_Static/models/StaticResNeXt101_50epoch.sav")
directory = "./clean/AllSubjects/E2_Static/data/jpg/"
...
all_preds.to_csv("./clean/AllSubjects/Ensemble/data/StaticPreds_ResNeXt101_GPU.csv")
