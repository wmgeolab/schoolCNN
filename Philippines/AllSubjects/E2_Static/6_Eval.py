...
checkpoint = torch.load("./Philippines/AllSubjects/E2_Static/models/Static_50epoch.torch")
model_ft.load_state_dict(checkpoint['model_state_dict'])
	
	
directory = "./Philippines/AllSubjects/E2_Static/data/jpg/"
...
all_preds.to_csv("./Philippines/AllSubjects/Ensemble/data/StaticPreds_ResNeXt101_GPU.csv")
