...
dta = pd.read_csv("./Philippines/AllSubjects/Ensemble1_LandsatResNeXt101/data/y1314_AllSubjects.csv")
dta = dta.drop(['overall_mean', 'latitude', 'longitude'], axis = 1)
dta.head()

# Landsat
landsat_pass = pd.read_csv("./Philippines/AllSubjects/Ensemble/data/LandsatPassPreds_GPU.csv")
landsat_pass = landsat_pass.drop(['Unnamed: 0'], axis = 1)
landsat_pass.head()
landsat_pass.shape

landsat_fail = pd.read_csv("./Philippines/AllSubjects/Ensemble/data/LandsatFailPreds_GPU.csv")
...
# Static
static = pd.read_csv("./Philippines/AllSubjects/Ensemble/data/StaticPreds_GPU.csv")
...
comb.to_csv("./Philippines/AllSubjects/Ensemble/data/EnsemblePreds_GPU.csv", index = False)